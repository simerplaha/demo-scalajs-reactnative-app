...
object NativeApp extends JSApp {
  ...
  class Backend(backendScope: BackendScope[NavigatorM, _]) {
  ...
  val component = ReactComponentB[NavigatorM]("SriMobileTemplate")
    .stateless
  ...
  val loginScreen = ReactComponentB[Unit]("LoginScreen")
    .render((P) => {
  ...
  def main() = {
    //    val ScalaJSReactNative = ReactComponentB[Unit]("SriMobileTemplate")
    //      .render((P) => {
    //        //      HelloNative()
    //        //      MoviesApp()
    //        component()
    ...
    //    React.AppRegistry.registerComponent("SriMobileTemplate", () => React.createClass(loginScreen))
    React.AppRegistry.registerComponent("MyApp", () => React.createClass(RootNavigation.component))
  }
